...
function Enemy1(config,myplane) {
  ...
  game.States.start1 = function() {
    ...
    this.myFireBullet = function() {
        ...
        {
            if(this.myplane.final_skill==3) this.skill1.destroy();
            else if (this.myplane.final_skill==2) this.skill2.destroy();
            else if (this.myplane.final_skill==1) this.skill3.destroy();
  ...
  game.States.start2 = function() {
    ...
    this.myFireBullet = function() {
        ...
        if(bullet && finalskillbutton.isDown&&this.myplane.final_skill>0)
        {
           ...
           // console.log(this.myplane.final_skill);
            bullet = this.mybullets.getFirstExists(false);  
            if(bullet) {
                bullet.reset(this.myplane.x + 30, this.myplane.y - 15);
                bullet.body.velocity.y = -400;
    ...
    this.update = function() {
      this.text.setText("Score: " + score);
      //this.text1.setText("Left lives: "+ this.myplane.level);
      //this.text2.setText("Left Skills: "+ this.myplane.final_skill);
